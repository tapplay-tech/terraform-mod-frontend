...
This repository that brings together all the frontend resources needed to provision and maintain an Frontend on AWS.

To use this module, you will need to make a link to this repo, and will use the resources like we did make in the [example path](https://github.com/tapplay-tech/terraform-mod-frontend/tree/main/example).
